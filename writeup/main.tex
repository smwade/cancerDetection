...
\documentabstract{%
  ...
  /section{thesis statment}

  Recent advances in neural networks can be applied to the early detection of cervical cancer. This makes use of CNNS and synthetic data
