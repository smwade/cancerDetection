...
\newcommand{\Title}{Cervical Cancer Detection with Synthetic Data and CNNs (TODO: new title?)}
...
\hypersetup{%
    ...
    pdfkeywords={segmentation, CNN, synthetic data, data augmentation, cervical cancer, mediacl imaging}%
}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.7\textwidth]{91_2000}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=.7\textwidth]{good_pix2pix}
\end{figure}
