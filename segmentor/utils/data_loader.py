...
class Dataset():
    ...
    def __init__(self, data_dir, batch_size, augment=False, gpu_id=0, num_gpus=1, seed=0):
        ...
        self._train_images = \
            self._load_npy(os.path.join(self._data_dir, 'train-volume.npy'))
        self._train_masks = \
            self._load_npy(os.path.join(self._data_dir, 'train-labels.npy'))
        self._test_images = \
            self._load_npy(os.path.join(self._data_dir, 'test-volume.npy'))
